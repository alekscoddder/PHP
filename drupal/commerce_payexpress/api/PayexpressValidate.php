 ...
 */
	class EXPC2PValidate {
		...
		{
			return EXPC2PValidate::isEmpty($email) OR preg_match('/^[a-z0-9!#$%&\'*+\/=?^`{}|~_-]+[.a-z0-9!#$%&\'*+\/=?^`{}|~_-]*@[a-z0-9]+[._a-z0-9-]*\.[a-z0-9]+$/ui', $email);
		}
		...
		{
			return EXPC2PValidate::isEmpty($ip) OR preg_match('/^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$/', $ip);
		}
